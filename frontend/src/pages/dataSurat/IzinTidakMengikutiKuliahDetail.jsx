...
import { SquarePen, ArrowLeft, FileText, Users, GraduationCap, CalendarDays, Info, MessageSquare, Check, X } from "lucide-react";
...
function MahasiswaItem({ index, mhs, showIndex }) {
  return (
    <div className="mb-4 last:mb-0">
      ...
      <p className="text-xs font-medium text-primary-1 mt-0.5">{mhs.nim} · {mhs.prodi} · {mhs.mataKuliah}</p>
    </div>
  );
}
