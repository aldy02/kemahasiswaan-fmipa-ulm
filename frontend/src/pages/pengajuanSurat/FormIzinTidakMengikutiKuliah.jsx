  ...
  const s2 = (
    <FormCard icon={<GraduationCap size={18} />} title="Informasi Mata Kuliah" subtitle="Data mata kuliah dan dosen pengampu yang akan ditinggalkan">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div><FormLabel required>Nama Dosen</FormLabel><FormTextInput placeholder="Masukkan nama dosen pengampu" value={namaDosen} onChange={setNamaDosen} /></div>
        <div><FormLabel required>Mata Kuliah</FormLabel><FormTextInput placeholder="Masukkan nama mata kuliah" value={mataKuliah} onChange={setMataKuliah} /></div>
        <div><FormLabel required>Program Studi</FormLabel><FormSelectInput placeholder="Pilih program studi dosen" value={prodiDosen} onChange={setProdiDosen} options={PRODI_OPTIONS} /></div>
      </div>
    </FormCard>
  );
  ...
  return (
    <MainLayout>
      ...
      <div className="mx-0 lg:mx-8 pb-10">
        <FormDesktopPanel title="Form Izin Tidak Mengikuti Kuliah" subtitle={subtitle} footer={<FormDesktopFooter />}>
          {sections}
        </FormDesktopPanel>
