// src/pages/pengajuanSurat/FormKeterangan.jsx
...
export default function FormKeterangan() {
    ...
    const s2 = (
        <FormCard key="mhs" icon={<User size={18} />} title="Informasi Mahasiswa" subtitle="Informasi lengkap mahasiswa yang mengajukan surat keterangan">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div><FormLabel required>Nama Mahasiswa</FormLabel><FormTextInput placeholder="Masukkan nama lengkap" value={namaMhs} onChange={setNamaMhs} /></div>
                ...
                <div><FormLabel required>Angkatan</FormLabel><FormSelectInput placeholder="Pilih angkatan" value={angkatan} onChange={setAngkatan} options={ANGKATAN_OPTIONS} /></div>
    ...
    const s3 = (
        <FormCard key="permohonan" icon={<FileText size={18} />} title="Detail Permohonan" subtitle="Informasi terkait keperluan dan tanggal pengajuan surat keterangan">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div><FormLabel required>Keperluan</FormLabel><FormTextInput placeholder="Masukkan keperluan surat keterangan" value={keperluan} onChange={setKeperluan} /></div>
    ...
    const s4 = (
        <FormCard key="tambahan" icon={<MessageSquare size={18} />} title="Informasi Tambahan" subtitle="Catatan atau keterangan tambahan terkait surat keterangan">
    ...
    return (
        <MainLayout>
            ...
            <div className="mx-0 lg:mx-8 pb-10">
                <FormDesktopPanel title="Form Surat Keterangan" subtitle={subtitle} footer={<FormDesktopFooter />}>{sections}</FormDesktopPanel>
